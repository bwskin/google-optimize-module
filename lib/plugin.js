...
//   if (console.trace) {
//     if (process.env && process.env.whitelabel) {
//       console.trace("SET_COOKIE", JSON.stringify({name, value, maxAge, whitelabel: process.env.whitelabel}, null, 4))
//     } else {
//       console.trace("SET_COOKIE", JSON.stringify({name, value, maxAge}, null, 4))
//     }
//   } else {
//     if (process.env && process.env.whitelabel) {
//       console.log("SET_COOKIE", JSON.stringify({name, value, maxAge, whitelabel: process.env.whitelabel}, null, 4))
//     } else {
//       console.log("SET_COOKIE", JSON.stringify({name, value, maxAge}, null, 4))
//     }
//   }
  if (process && process.env && process.env.whitelabel) {
    console.log("SET_COOKIE", JSON.stringify({name, value, maxAge, whitelabel: process.env.whitelabel}, null, 4))
  } else {
    console.log("SET_COOKIE", JSON.stringify({name, value, maxAge}, null, 4))
  }
